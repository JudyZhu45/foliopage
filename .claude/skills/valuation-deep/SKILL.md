...
```json
{
  "meta": {"stock_code": "<code>", "stock_name": "<name>", "skill": "valuation-deep", "as_of": "<ISO datetime>"},
  "hero": {"industry": "<sector>", "exchange": "<SH|SZ|HK|…>", "as_of": "<date>"},
  "kpi": {"pe_ttm": null, "pe_percentile": null, "pb": null, "ev_ebitda": null, "dividend_yield_pct": null, "roe_pct": null, "as_of": "<date>"},
  "pe_history": [{"date": "YYYY-MM-DD", "pe": 0.0}],
  "peer_bar_metric": "PE(TTM)",
  "peer_bar_items": [{"code": "<code>", "name": "<name>", "PE(TTM)": null}],
  "radar_subject": {"code": "<code>", "name": "<name>", "pe": null, "pb": null, "ev_ebitda": null, "roe": null, "gross_margin": null},
  "radar_peers": [{"code": "<code>", "name": "<name>", "pe": null, "pb": null, "ev_ebitda": null, "roe": null, "gross_margin": null}],
  "radar_metrics": ["pe", "pb", "ev_ebitda", "roe", "gross_margin"],
  "valuation_snapshot": "<2-3 sentences, ≥1 [[code|name]] link>",
  "pe_band_narrative": "<2-3 sentences: PE vs historical range, peaks/troughs>",
  "peers": [{"code": "<code>", "name": "<name>", "pe_ttm": null, "pb": null, "ev_ebitda": null, "roe_pct": null, "gross_margin_pct": null}],
  "peer_narrative": "<2-3 sentences, premium/discount rationale, ≥2 [[code|name]] links>",
  "implied_growth_rate": null,
  "implied_growth_note": "<one sentence: Gordon/DDM formula, label as inferred>",
  "analyst_target_low": null, "analyst_target_high": null, "analyst_count": null,
  "valuation_narrative": "<4 paragraphs \\n\\n: PE percentile, analyst range, key risk, overall. ≥2 [[code|name]]>",
  "pull_quote": "<striking valuation data point>"
}
```
